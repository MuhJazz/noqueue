document.addEventListener("DOMContentLoaded", () => {
  ...
  const signupPemilikiRestoForm = document.querySelector("#form-daftar-pemilik-resto");
  const signupRestoForm = document.querySelector("#form-daftar-resto");

  document.querySelector("#linkFormPemilikResto").addEventListener("click", (e) => {
    e.preventDefault();
    signupUserForm.classList.add("form-daftar-pemilik-resto-hidden");
    signupPemilikiRestoForm.classList.remove("form-daftar-pemilik-resto-hidden");
  });
  document.querySelector("#button-lanjut-daftar-resto").addEventListener("click", (e) => {
    e.preventDefault();
